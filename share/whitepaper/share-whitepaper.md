...
Share is a protocol that enables artists to make 100-1000x+ more money for their music. It does so not by charging listeners an exorbitant amount of money for collectibles, but by eliminating the dependence on centralized content streaming (e.g. Spotify, Apple Music, Youtube) altogether.

Imagine you’re a creator, and you have an audience of 1000 people. You post a song, one of the most intimate, beautiful creations you have ever made to the blockchain. You set the price to experience the content at $1, and share it with the people who couldn't wait to hear it. The song itself is a revenue generating, tradeable asset, that can be unlocked using an instant microtransaction with no sign-in. It's available on every metaverse streaming app in perpetuity. Your audience grows and you repeat. Your vintage pieces start to generate even more monthly revenue, enabling you to create even better content. Your audience can buy into the content so that they receive a portion of the future revenues as well. This is a decentralized pay-for-access digital content marketplace. Not only is it a marketplace to collect the content, but a marketplace to *experience* the content. 

Share is a decentralized streaming protocol and platform that reimagines how digital content such as music and video is distributed and consumed using peer-to-peer pay-per-view microtransactions on blockchain. Users instantly authenticate without signing in, and for every time they watch, listen to or read your content, a fast micropayment grants access. Most importantly, the price of the micropayment is set by the creator. It can range from being free, to upwards of hundreds of dollars per experience. The creator decides, not the platform. Share inverts the access model.
